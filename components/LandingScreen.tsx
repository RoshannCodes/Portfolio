const LandingScreen = () => {
    return (
        <div className="min-h-screen w-full flex flex-row items-center justify-start md:px-16 bg-[url('/images/profilenbg.jpeg')] bg-no-repeat md:bg-contain bg-cover bg-[70%] md:bg-[center_left_40%] [clip-path:inset(0_0_10%_0)] bg-fixed md:bg-scroll md:mb-10 mb-5">
